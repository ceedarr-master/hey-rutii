...
export function renderProfile() {
  ...
  return `
    <div style="padding-bottom:var(--space-60);">
      <div class="card" style="text-align:left; padding:24px; margin-bottom:16px; background:#ffffff; border-radius:24px; border:1px solid var(--border-base);">
        ...
        <div style="display:flex; justify-content:flex-end; gap:8px;">
          ${state.userProfile && state.userProfile.display_name ? `<button class="btn-md btn-warning" onclick="window.resetProfile()">프로필 초기화 하기</button>` : ''}
          <button class="btn-md btn-secondary" onclick="window.saveProfile()">변경사항 저장하기</button>
        </div>
      </div>
      
      <div class="card" style="text-align:left; padding:24px; background:#ffffff; border-radius:24px; border:1px solid var(--border-base);">
        ...
        <div style="display:flex; justify-content:flex-end;">
          <button class="btn-md btn-secondary" onclick="window.handleProfileUpdatePassword()">변경하기</button>
        </div>
      </div>
    </div>`;
}
